...
default[:cloudera_cdh][:namenode][:host] = "hadoop-hdp2-node1"
...
#Map Reduce
default[:cloudera_cdh][:jobtracker][:host] = "hadoop-hdp2-node2"
...
#HiveServer2
default[:cloudera_cdh][:hiveserver][:host] = "hadoop-hdp2-node2"
