...
default[:bdas][:namenode][:dfs_name_dir] = "/var/lib/hadoop/cache/hadoop/dfs/name"  
default[:bdas][:namenode][:hadoop_tmp_dir] = "/var/lib/hadoop/cache/${user.name}"
default[:bdas][:namenode][:dfs_name_dir_root] = "/hadoop"
...
default[:bdas][:shark][:wget_path] = "http://spark-project.org/download/shark-0.7.0-hadoop2-bin.tgz"
...
default[:bdas][:spark][:dist] = "spark-0.7.2"
default[:bdas][:shark][:dist] = "shark-0.7.0-hadoop2-bin.tgz"
default[:bdas][:scala][:home] = "/usr/local/scala-2.9.3"
default[:bdas][:shark][:home] = "/usr/local/spark-0.7.2"
default[:bdas][:shark][:home] = "/usr/local/shark-0.7.0"
